...
export default function FormContrato({ onCancel, initialData, currentUser }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = { ...formData, usuario_id: currentUser.id };
  ...
  return (
    <div className="flex min-h-screen items-start justify-center pt-32 p-12 bg-black">
      <form
        onSubmit={handleSubmit}
        className="w-full max-w-5xl bg-gray-100 rounded-3xl shadow-lg p-12 space-y-10"
      >
        <h2 className="text-3xl font-bold text-indigo-600 text-center border-b pb-2">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
              <label className="block text-sm text-gray-800">DNI / CUIT</label>
              <input
                type="text"
                name="inquilinoDni"
            ...
            <div>
              <label className="block text-sm text-gray-800">Dirección</label>
              <input
                type="text"
        ...
        {/* Contrato */}
        <div className="bg-white rounded-xl shadow-md p-6 space-y-4">
          <h3 className="text-xl font-semibold text-indigo-800 border-b pb-2">
            Datos del Contrato
          </h3>
        ...
        <div className="bg-white rounded-xl shadow-md p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <input
                type="text"
                name="garanteApellido"
                value={formData.garanteApellido}
                onChange={handleChange}
                className="w-full mt-1 p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
            </div>
            ...
            <div>
              <label className="block text-sm text-gray-800">Exhibición</label>
              <input
                type="text"
                name="garanteExhibición"
                value={formData.garanteExhibición}
                onChange={handleChange}
                className="w-full mt-1 p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
            </div>
            <div>
              <label className="block text-sm text-gray-800">Telefono</label>
              <input
                type="text"
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-6">
          <button
            type="submit"
            className="flex-1 bg-indigo-500 text-white font-semibold py-3 rounded-xl shadow-md hover:bg-indigo-600 transition"
          >
